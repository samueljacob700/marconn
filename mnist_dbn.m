...
bh1 = zeros(nh1,1);
bv1 = zeros(nv,1);
[w1,bh1,bv1,h1] = train_rbm(w1,bh1,bv1,data,nepochs,batchsize,epsw,epsbh,epsbv);
save
...
bh2 = zeros(nh2,1);
bv2 = zeros(nh1,1);
[w2,bh2,bv2,h2] = train_rbm(w2,bh2,bv2,h1,nepochs,batchsize,epsw,epsbh,epsbv);
save
...
bh3 = zeros(nh3,1);
bv3 = zeros(nh2,1);
[w3,bh3,bv3,h3] = train_rbm(w3,bh3,bv3,h2,nepochs,batchsize,epsw,epsbh,epsbv);
save
...
bh4 = zeros(nh4,1);
bv4 = zeros(nh3,1);
[w4,bh4,bv4,h4] = train_rbm(w4,bh4,bv4,h3,nepochs,batchsize,epsw,epsbh,epsbv);
save
